                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <h1 style="text-align: right">
                                <a href="{{ route('admin.skill.create') }}" class="btn btn-primary btn-md"><span class="lnr lnr-pencil left"></span>Create Skill</a>
                            </h1>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding-left: 5px;">
                                            <ul class="tbl-action-btn">
                                                <li>
                                                    <a href="{{ route ('admin.skill.edit', $skill->id) }}" class="btn btn-info btn-xs text-center">
