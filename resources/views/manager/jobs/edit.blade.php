...
@section('content')
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h1 style="text-align: right">
                                <a href="{{ route('manager.jobs.index') }}" class="btn btn-success btn-md"><span class="lnr lnr-arrow-left"></span>Back</a>
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <form method="POST" action="{{ route ('manager.jobs.update', $jobPost->id) }}" enctype="multipart/form-data">
        <div class="col-md-9">
            @csrf
            @method('patch')
            <div class="panel">
