                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <h1 style="text-align: right">
                                    <a href="{{ route('manager.jobs.create') }}" class="btn btn-primary btn-md"><span class="lnr lnr-pencil left"></span>Post Job</a>
                                </h1>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding-left: 5px;">
                                            <ul class="tbl-action-btn">
                                                <li>
                                                    <a href="{{ route ('manager.jobs.show', $job->id) }}" class="btn btn-success btn-xs text-center">
                                                        <span class="lnr lnr-eye left tb-btn"></span>
                                                    </a>
                                                </li>

                                                <li>
                                                    <a href="{{ route ('manager.jobs.edit', $job->id) }}" class="btn btn-info btn-xs text-center">
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-form-{{ $job->id }}" action="{{ route('manager.jobs.destroy', $job->id)}}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
