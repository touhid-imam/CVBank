            ...
            <div class="profile-right">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab-bottom-left1">
                        ...
                        <form method="POST" action="{{ route('jobseeker.profile.update', $user->id) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                    ...
                    <div class="tab-pane fade" id="tab-bottom-left2">
                        ...
                        <form method="POST" action="{{ route('jobseeker.password-update', $user->id) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="tab-bottom-left3">
                        ...
                        <form method="POST" action="{{ route('jobseeker.personal.update', $personal->id) }}">
                            @method('PATCH')
                            @csrf
                            <div class="form-group">
