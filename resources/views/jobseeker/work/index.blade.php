                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <h1 style="text-align: right">
                                <a href="{{ route('jobseeker.work.create') }}" class="btn btn-primary btn-md"><span class="lnr lnr-pencil left"></span>Create Work</a>
                            </h1>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding-left: 5px;">
                                            <ul class="tbl-action-btn">
                                                <li>
                                                    <a href="{{ route ('jobseeker.work.edit', $work->id) }}" class="btn btn-info btn-xs text-center">
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-form-{{ $work->id }}" action="{{ route('jobseeker.work.destroy', $work->id)}}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
