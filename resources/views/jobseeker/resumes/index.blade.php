                    ...
                    <div class="col-md-6">
                        <div class="panel-body">
                            <h1 style="text-align: right">
                                <a href="{{ route('jobseeker.resumes.create') }}" class="btn btn-primary btn-md"><span class="lnr lnr-pencil left"></span>Create Resume</a>
                            </h1>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="padding-left: 5px;">
                                        <ul class="tbl-action-btn">
                                            <li>
                                                <a href="{{ route('jobseeker.resumes.edit', $resume->id) }}" class="btn btn-info btn-xs text-center"><span class="lnr lnr-sync left tb-btn"></span></a>
                                            </li>

                                            <li>
                                                <button class="btn btn-danger btn-xs" onclick="deleteResume({{ $resume->id }})"><span class="lnr lnr-trash left tb-btn"></span></button>

                                                <form id="delete-form-{{ $resume->id }}" action="{{ route('jobseeker.resumes.destroy', $resume->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </li>
