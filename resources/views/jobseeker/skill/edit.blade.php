...
@section('content')
    <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-body">
                            <h1 style="text-align: right">
                                <a href="{{ route('jobseeker.skill.index') }}" class="btn btn-success btn-md"><span class="lnr lnr-arrow-left"></span>Back</a>
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body">
                    <form method="POST" action="{{ route('jobseeker.skill.update', $skill->id) }}">
                        @csrf
                        @method('patch')
