    ...
    <div class="row">
        ...
        <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <div class="panel-body">
                            <h1 style="text-align: right">
                                <a href="{{ route('jobseeker.hobbies-facts.index') }}" class="btn btn-success btn-md"><span class="lnr lnr-arrow-left"></span>Back</a>
                            </h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('jobseeker.hobbies-facts.update', $id) }}">
                        @method('PATCH')
                        @csrf
