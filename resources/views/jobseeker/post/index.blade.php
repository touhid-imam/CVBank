                ...
                <div class="panel panel-heading-">
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('jobseeker.post.create') }}" class="btn btn-primary btn-md"><span class="lnr lnr-pencil left"></span>Create Post</a>
                            </h1>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding-left: 5px;">
                                            <ul class="tbl-action-btn">
                                                <li>
                                                    <a href="{{ route ('jobseeker.post.edit', $post->id) }}" class="btn btn-info btn-xs text-center">
                                                ...
                                                <li>
                                                    ...
                                                    <form id="delete-form-{{ $post->id }}" action="{{ route('jobseeker.post.destroy', $post->id)}}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
