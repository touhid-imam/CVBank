...
<script src="{{asset ('public/front/assets/js/jquery.waypoints.min.js')}}"></script>
...
<script src="{{asset ('public/front/assets/js/jquery.animateNumber.min.js')}}"></script>
<script src="{{asset ('public/front/assets/js/bootstrap-datepicker.js')}}"></script>
{{--<script src="{{asset ('public/front/assets/js/jquery.timepicker.min.js')}}"></script>--}}
<script src="{{asset ('public/front/assets/js/scrollax.min.js')}}"></script>
{{--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>--}}
<script src="{{asset ('public/front/assets/js/google-map.js')}}"></script>
