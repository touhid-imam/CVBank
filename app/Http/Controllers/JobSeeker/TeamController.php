...
class TeamController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jobseeker.team.index', compact ('teams'));
    }
    ...
    public function create()
    {
        ...
        return view('jobseeker.team.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jobseeker.team.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('jobseeker.team.edit', compact ('team'));
    }
